...
{
  var review = new Carousel(".review-item", ".review-dot");
  var reviewInterval;
  ...
  forEach(review.items, function (item, index) {
...
{
  var location = new Carousel(".location-item", ".location-dot");
  forEach(location.items, function (item, index) {
    location.hideOldItem().showNewItem(index);
  });
}
},{"./forEach":"js/utilities/dom/forEach.js","../styles":"js/utilities/styles.js","./changeVisibility":"js/utilities/dom/changeVisibility.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","js/utilities/dom/carousel.js"], null)
//# sourceMappingURL=/carousel.6e2b439e.js.map