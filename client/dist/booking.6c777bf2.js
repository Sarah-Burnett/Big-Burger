...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"js/utilities/booking/types.js":[function(require,module,exports) {
"use strict";
...
},{"./types":"js/utilities/booking/types.js","../dom/toggleModal":"js/utilities/dom/toggleModal.js","../dom/setInnerHTML":"js/utilities/dom/setInnerHTML.js"}],"node_modules/date-fns/esm/_lib/toInteger/index.js":[function(require,module,exports) {
"use strict";
...
var autoFillForm = function autoFillForm(data) {
  ...
  if (typeof data.date !== "string") data.date = (0, _dateFns.format)(date, "dd/MM/yyyy");
...
},{"date-fns":"node_modules/date-fns/esm/index.js","../dom/toggleModal":"js/utilities/dom/toggleModal.js"}],"js/utilities/booking/validateBooking.js":[function(require,module,exports) {
"use strict";
...
exports.findBookingfromForm = exports.findBookingfromURL = void 0;
...
var findBookingfromURL = function findBookingfromURL() {
...
exports.findBookingfromURL = findBookingfromURL;
...
},{}],"js/utilities/dom/createButton.js":[function(require,module,exports) {
"use strict";
...
var setAvailableDates = function setAvailableDates(today) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      console.log(_typeof(date), _typeof(newButton.dataset.value));
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
},{"date-fns/addDays":"node_modules/date-fns/esm/addDays/index.js","date-fns/format":"node_modules/date-fns/esm/format/index.js","../dom/createButton":"js/utilities/dom/createButton.js"}],"js/utilities/booking/submitBooking.js":[function(require,module,exports) {
"use strict";
...
},{"./fetch":"js/utilities/booking/fetch.js","./validateBooking":"js/utilities/booking/validateBooking.js","../storage/addSessionStorage":"js/utilities/storage/addSessionStorage.js"}],"js/utilities/booking/availableParty.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setAvailableParty = void 0;
...
var _require = require("../dom/createButton"),
    createDropdownButton = _require.createDropdownButton;

var getAvailableParty = function getAvailableParty(restaurant, date, time) {
  //TODO:query db for availability
  return [2, 3, 4, 5, 6, 7, 8];
};

var setAvailableParty = function setAvailableParty(restaurant, date, time) {
  var sizes = getAvailableParty(restaurant, date, time);
...
},{"../dom/createButton":"js/utilities/dom/createButton.js"}],"js/utilities/dom/addEventListener.js":[function(require,module,exports) {
"use strict";
...
},{}],"js/utilities/booking/availableTimes.js":[function(require,module,exports) {
"use strict";
...
var getAvailableTimes = function getAvailableTimes(date, restaurant) {
  ...
  var _openingHours$restaur = _slicedToArray(openingHours[restaurant][day], 2),
      ...
      closing = _openingHours$restaur[1];
  ...
  while (current <= closing) {
    times.push((0, _format.default)(current, "HH:mm"));
    current = (0, _dateFns.addMinutes)(current, 30);
  }
...
var changeFormValue = function changeFormValue(btn) {
  (0, _addEventListener.addEventListener)(btn, function () {
    ...
    if (btn.dataset.input === "#date") {
      (0, _availableTimes.setAvailableTimes)(new Date(btn.dataset.value), restaurant);
    }
  });
};

exports.changeFormValue = changeFormValue;
},{"../dom/addEventListener":"js/utilities/dom/addEventListener.js","./availableTimes":"js/utilities/booking/availableTimes.js"}],"js/booking.js":[function(require,module,exports) {
"use strict";

var _findBooking = require("./utilities/booking/findBooking");

var _editForm = require("./utilities/booking/editForm");

var _fetch = require("./utilities/booking/fetch");
...
(0, _availableParty.setAvailableParty)();
(0, _forEach.forEach)(".dropdownBtn", _changeFormValue.changeFormValue); //edit form
...
},{"./utilities/booking/findBooking":"js/utilities/booking/findBooking.js","./utilities/booking/editForm":"js/utilities/booking/editForm.js","./utilities/booking/fetch":"js/utilities/booking/fetch.js","./utilities/booking/types":"js/utilities/booking/types.js","./utilities/booking/availableDates":"js/utilities/booking/availableDates.js","./utilities/booking/submitBooking":"js/utilities/booking/submitBooking.js","./utilities/booking/availableParty":"js/utilities/booking/availableParty.js","./utilities/booking/changeFormValue":"js/utilities/booking/changeFormValue.js","./utilities/dom/forEach":"js/utilities/dom/forEach.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
